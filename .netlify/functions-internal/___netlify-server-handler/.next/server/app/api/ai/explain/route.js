"use strict";(()=>{var e={};e.id=729,e.ids=[729],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},7310:e=>{e.exports=require("url")},9796:e=>{e.exports=require("zlib")},112:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>x,originalPathname:()=>w,patchFetch:()=>$,requestAsyncStorage:()=>m,routeModule:()=>l,serverHooks:()=>d,staticGenerationAsyncStorage:()=>h,staticGenerationBailout:()=>y});var a={};r.r(a),r.d(a,{POST:()=>p});var s=r(5419),o=r(9108),n=r(9678),i=r(8070),c=r(5009),u=r(2509);async function p(e){try{let t=await (0,u.e)(),{data:{user:r}}=await t.auth.getUser();if(!r)return i.Z.json({error:"未登录"},{status:401});let{code:a,language:s,context:o}=await e.json();if(!a||!s)return i.Z.json({error:"缺少必要参数"},{status:400});let n=await c.c.explainCode(a,s,o);return i.Z.json({success:!0,explanation:n})}catch(e){return console.error("AI讲解失败:",e),i.Z.json({error:e.message||"AI服务暂时不可用"},{status:500})}}let l=new s.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/ai/explain/route",pathname:"/api/ai/explain",filename:"route",bundlePath:"app/api/ai/explain/route"},resolvedPagePath:"C:\\Users\\wangqiyuan\\project\\cursor\\aicodegame\\src\\app\\api\\ai\\explain\\route.ts",nextConfigOutput:"standalone",userland:a}),{requestAsyncStorage:m,staticGenerationAsyncStorage:h,serverHooks:d,headerHooks:x,staticGenerationBailout:y}=l,w="/api/ai/explain/route";function $(){return(0,n.patchFetch)({serverHooks:d,staticGenerationAsyncStorage:h})}},5009:(e,t,r)=>{r.d(t,{c:()=>s});class a{constructor(e=process.env.DEEPSEEK_API_KEY||"",t=process.env.DEEPSEEK_API_URL||"https://api.deepseek.com",r="deepseek-coder"){this.apiKey=e,this.baseURL=t,this.model=r}async chat(e,t){if(!this.apiKey)throw Error("DeepSeek API密钥未配置");try{let r=await fetch(`${this.baseURL}/v1/chat/completions`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`},body:JSON.stringify({model:this.model,messages:e,temperature:t?.temperature||.7,max_tokens:t?.maxTokens||2e3,stream:t?.stream||!1})});if(!r.ok){let e=await r.json();throw Error(`DeepSeek API错误: ${e.message||r.statusText}`)}let a=await r.json();return a.choices[0]?.message?.content||""}catch(e){throw console.error("DeepSeek API调用失败:",e),e}}async explainCode(e,t,r){let a=[{role:"system",content:"你是一个专业的编程教学助手。你的任务是用简单易懂的中文解释代码,适合编程初学者理解。"},{role:"user",content:`请详细解释以下${t}代码的作用:
